...
def get_tensorinputs_and_labels(forceNew = False, flip = False, rotate = False, takeEveryStep = False, howManyStates = 2):
	...
	if not os.path.isfile("data/tensorinputs80.p") or not os.path.isfile("data/labels80.p") or forceNew:
		...
		for i in range(81):
			...
			tensorinputs.append(pickle.load(open("data/tensorinputs{}.p".format(i), "rb")))
			labels.append(pickle.load(open("data/labels{}.p".format(i), "rb")))
